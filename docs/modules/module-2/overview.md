---
title: 'Module 2 Overview: Agent Reasoning Architectures and Tool Integration'
description: 'Overview of Module 2 (8 hours): agent reasoning paradigms (Chain-of-Thought, ReAct, Tree of Thoughts, LATS), LangChain tool integration, prompt design, reasoning-trace evaluation, chapter checklist, and grade weights.'
type: Overview
tags:
- module-2
- student-facing
...
- id: wiki-v2
  ...
  title: 'AI Automation and Agents v2 wiki: Module-2:-Overview'
  author: Carlos Lizárraga-Celaya; Michelle Yung
  last_modified: '2026-08-06T07:00:53-07:00'
wiki_page: Module-2:-Overview
---
...
<p class="course-provenance" markdown>Migrated from the [course wiki](https://github.com/UA-AI2S/AI-Automation-and-Agents-v2/wiki/Module-2:-Overview){target=_blank} (wiki page last changed 2026-08-06). Spotted a problem? [Edit this page](https://github.com/tyson-swetnam/AI-Automation-and-Agents/edit/main/docs/modules/module-2/overview.md){target=_blank}.</p>
