...
!!! info "What to submit"
    ...
    **Add to github**: Submit the lab notebook with your new tool added: its definition and description, the three test prompts run with output visible, and your before-and-after comparison. The project has its own section at the end of the lab notebook, so the filename is the same: `Module2_Lab_[YourName].ipynb`.
